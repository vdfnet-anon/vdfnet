...
def save_checkpoint(save_path, optimizer, vdfnet, epoch, num_iter,
    ...
    state = {
        ...
        'state_dict': vdfnet.state_dict()
    }
    save_filename = 'vdfnet_epoch_{:0>3d}.pth'.format(epoch) if filename is None else filename
    ...
    if save_optimizer:
        ...
        optimizer_name = save_filename.replace('vdfnet', 'optimizer')
