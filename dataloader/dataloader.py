...
class StereoDataset(Dataset):
    def __init__(self, data_dir,
        ...
        kitti_mix_dict = {
            'train': 'filenames/kittitrain.txt',
            'val': 'filenames/kittival.txt',
            'test': 'filenames/KITTI_2015_val.txt'
        }

        middlebury_dict = {
            'train': 'filenames/Middlebury_train.txt',
            'val': 'filenames/Middlebury_test.txt',
            'test': 'filenames/Middlebury_test.txt'
        }

        eth3d_dict = {
            'train': 'filenames/ETH3D_train.txt',
            'val': 'filenames/ETH3D_test.txt',
            'test': 'filenames/ETH3D_test.txt'
        }
