"""Evaluate Exp A (soft-argmin) on SceneFlow test set."""
import os
import sys
...
def main():
    ...
    parser.add_argument('--ckpt', default='checkpoints/200000_igev_original.pth')
